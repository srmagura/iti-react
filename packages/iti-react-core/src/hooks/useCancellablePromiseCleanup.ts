 ...
 * cancels them when the component unmounts. This is desirable in certain
 * situations to prevent callbacks passed down to a component from being called
 * after that component is unmounted.
 *
 * ```
